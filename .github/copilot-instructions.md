...
Las instrucciones principales, reglas y estado de este proyecto viven en **`CLAUDE.md`** (en la raíz del repositorio). Esa es la única fuente de verdad para la arquitectura, convenciones y estado del proyecto.
